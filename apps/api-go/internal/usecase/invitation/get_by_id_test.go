...
func TestGetInvitationByIDUseCase_Execute_InvitationFound_ReturnsInvitation(t *testing.T) {
	// Arrange
	...
	assert.Equal(t, userID, output.Invitation.UserID, "User ID should match")
	assert.Equal(t, layoutID, output.Invitation.LayoutID, "Layout ID should match")
	mockRepo.AssertExpectations(t)
}

func TestGetInvitationByIDUseCase_Execute_InvitationNotFound_ReturnsError(t *testing.T) {
	// Arrange
