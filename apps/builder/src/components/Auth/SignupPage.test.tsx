  ...
  describe('Form Submission', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/Email already registered|email already registered/i)).toBeInTheDocument();
      });
    });
    ...
    it('should clear error when user starts typing', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByText(/Email already registered|email already registered/i)).not.toBeInTheDocument();
      });
    });
  });
