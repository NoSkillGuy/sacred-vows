...
const PreviewIcon = (): ReactElement => (
...
const GalleryIcon = (): ReactElement => (
  <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M4 22L10 16L14 20L20 14L28 22"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const LanguageIcon = (): ReactElement => (
  <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const RSVPIcon = (): ReactElement => (
  <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M6 8H26V24C26 25.1046 25.1046 26 24 26H8C6.89543 26 6 25.1046 6 24V8Z"
      stroke="currentColor"
      strokeWidth="2"
    />
...
const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Reach all your guests with support for multiple languages including English, Hindi, and more.",
  },
  {
    Icon: MobileIcon,
...
function FeaturesSection({ onSectionView }: FeaturesSectionProps): ReactElement {
  useEffect(() => {
    ...
    <section id="features" className="features-section">
      <div className="section-header">
        ...
        <p className="section-subtitle">
          Our platform is designed to make creating your perfect wedding invitation effortless and
          enjoyable.
        </p>
      </div>
