...
const PaletteIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 4C12.954 4 4 12.954 4 24C4 35.046 12.954 44 24 44C25.657 44 27 42.657 27 41C27 40.2 26.7 39.5 26.2 38.9C25.7 38.3 25.4 37.6 25.4 36.8C25.4 35.143 26.743 33.8 28.4 33.8H32C38.627 33.8 44 28.427 44 21.8C44 11.895 35.046 4 24 4Z" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
...
const EditIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M34 6L42 14L16 40H8V32L34 6Z" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M28 12L36 20" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
...
const SendIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M44 4L22 26" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M44 4L30 44L22 26L4 18L44 4Z" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
function HowItWorks({ onSectionView }) {
  ...
  return (
    <section id="how-it-works" className="how-it-works-section">
      ...
      <div 
        ref={containerRef}
        className={`steps-container ${inView ? 'in-view' : ''}`}
      >
