...
const PinterestIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 6C9 6 7 8.5 7 11C7 13 8 14.5 9.5 15C9.5 14.5 9.5 13.5 9.8 12.8C10 12.2 10.8 9 10.8 9C10.8 9 10.5 8.5 10.5 7.8C10.5 6.8 11 6 11.8 6C12.5 6 12.8 6.5 12.8 7.2C12.8 8 12.3 9.2 12 10C11.8 10.8 12.3 11.5 13 11.5C14.5 11.5 15.5 10 15.5 8C15.5 6.5 14.3 5.5 12 5.5C9.5 5.5 8 7.2 8 9.2C8 10 8.3 10.8 8.8 11.2C8.5 11.5 8.5 12 8.3 12C8 12 7.3 11.5 7.3 10C7.3 7.5 9 5 12 5C15 5 17 7 17 9.5C17 12.5 15 14.5 12.5 14.5C11.5 14.5 10.8 14 10.5 13.5L10 15.5C9.8 16.2 9.3 17 9 17.5L12 18C15.5 18 18 15 18 12C18 8.7 15.3 6 12 6Z" fill="currentColor"/>
  </svg>
);
...
const TwitterIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 4L10.5 12.5L4 20H6L11.5 14L16 20H20L13 10.5L19 4H17L12 9L8 4H4Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
