...
const OrnamentClassic = (): ReactElement => (
  <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M20 5C20 5 25 10 25 15C25 20 22 22 20 22C18 22 15 20 15 15C15 10 20 5 20 5Z"
      fill="currentColor"
      opacity="0.7"
    />
    <path
      d="M20 35C20 35 15 30 15 25C15 20 18 18 20 18C22 18 25 20 25 25C25 30 20 35 20 35Z"
      fill="currentColor"
      opacity="0.7"
    />
    <path
      d="M5 20C5 20 10 15 15 15C20 15 22 18 22 20C22 22 20 25 15 25C10 25 5 20 5 20Z"
      fill="currentColor"
      opacity="0.7"
    />
    <path
      d="M35 20C35 20 30 25 25 25C20 25 18 22 18 20C18 18 20 15 25 15C30 15 35 20 35 20Z"
      fill="currentColor"
      opacity="0.7"
    />
...
const OrnamentStar = (): ReactElement => (
  <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M20 4L22.5 15H33.5L24.5 22L27 33L20 26L13 33L15.5 22L6.5 15H17.5L20 4Z"
      fill="currentColor"
    />
  </svg>
);
...
const OrnamentSun = (): ReactElement => (
  <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M20 4V10M20 30V36M36 20H30M10 20H4M31.3 8.7L27 13M13 27L8.7 31.3M31.3 31.3L27 27M13 13L8.7 8.7"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
...
function LayoutShowcase({ onSectionView }: LayoutShowcaseProps): ReactElement {
  ...
  const filters = useMemo<Filter[]>(() => {
    const categories = Array.from(
      new Set(
        layouts
          .map((layout) => layout.metadata?.tags?.[0] || layout.metadata?.category || "")
          .filter(Boolean)
      )
    );
    ...
    <section id="layouts" className="layouts-section">
      <div className="section-header">
        ...
        <p className="section-subtitle">
          Choose from our handcrafted collection of stunning invitation designs, each thoughtfully
          created to capture the unique essence of your celebration.
        </p>
      </div>
              ...
              <div className={`layout-card ${demoLayout.className} demo-mode`}>
                <div className="layout-preview">
                  <div className="layout-inner">
                    ...
                    <div
                      className="layout-ornament"
                      style={{ color: demoLayout.ornamentColor, transform: "rotate(180deg)" }}
                    >
                      <demoLayout.Ornament />
                    </div>
                  </div>
