...
// Verified badge icon
const VerifiedIcon = (): ReactElement => (
...
const testimonials: Testimonial[] = [
  {
    content:
      "Sacred Vows made our wedding invitation absolutely magical. Our guests couldn't stop complimenting how beautiful and unique it was. The real-time preview feature made customization so easy!",
  ...
  {
    content:
      "We were amazed at how professional our invitation looked. The multi-language support was perfect for our multicultural wedding. Highly recommend to all couples!",
  ...
  {
    content:
      "The RSVP tracking feature saved us so much time. Everything was seamless from start to finish. Our invitation felt so personal and our guests loved the interactive elements.",
    author: "Meera & Arjun",
...
function Testimonials({ onSectionView }: TestimonialsProps): ReactElement {
  useEffect(() => {
