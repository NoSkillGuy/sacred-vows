...
const values: Value[] = [
  {
    ...
    title: "Love First",
    description:
      "Every feature we build, every design we create, starts with understanding the love story behind it. We celebrate the unique journey of each couple.",
  },
  {
    icon: <SparkleIcon />,
    title: "Excellence in Craft",
    description:
      "We obsess over every pixel, every animation, every interaction. Your special day deserves nothing less than perfection in every detail.",
  },
  {
    icon: <GlobeIcon />,
    title: "Accessible Beauty",
    description:
      "Beautiful wedding invitations should be available to everyone, regardless of budget. We democratize elegance through thoughtful design.",
  },
  {
    icon: <UsersIcon />,
    title: "Customer Obsessed",
    description:
      "Your success is our success. We're here to support you through every step, from your first design to your last RSVP.",
  },
];
        ...
        <section className="about-story">
          <div className="story-content">
            ...
            <p>
              ...
              Frustrated by expensive paper invitations and clunky digital alternatives, she
              envisioned something better: beautiful, personalized digital invitations that capture
