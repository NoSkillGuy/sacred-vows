...
const layoutsByCategory = {
  traditional: {
    name: "Traditional",
    description:
      "Classic elegance meets timeless design. Our traditional layouts feature refined ornaments, elegant typography, and sophisticated color palettes that honor wedding traditions.",
    layouts: [
      {
        id: "classic-scroll",
        name: "Classic Scroll",
  ...
  modern: {
    name: "Modern",
    description:
      "Contemporary designs for the modern couple. Bold typography, clean lines, and innovative layouts that make a statement.",
    layouts: [
      {
        id: "midnight-romance",
  ...
  minimal: {
    name: "Minimal",
    description:
      "Less is more. Our minimal layouts focus on typography, whitespace, and subtle details for couples who appreciate refined simplicity.",
    layouts: [
      {
        id: "classic-monogram",
  ...
  floral: {
    name: "Floral",
    description:
      "Nature-inspired beauty with romantic florals. From delicate watercolors to bold botanical prints, find the perfect floral design for your celebration.",
    layouts: [
      {
        id: "eternal-bloom",
        name: "Eternal Bloom",
...
function LayoutCategoryPage() {
  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[{ label: "Layouts", path: "/layouts-gallery" }, { label: categoryData.name }]}
    >
      <div className="layouts-gallery-page">
        {/* Category Navigation */}
        ...
        <div className="layouts-grid">
          {categoryData.layouts.map((layout) => (
            <div key={layout.id} className="layout-card">
              {layout.popular && <div className="popular-badge">Popular</div>}
              ...
              <div className="layout-preview">
                ...
                >
                  <div className="layout-ornament" style={{ color: layout.colors[0] }}>
                    ✦
                  </div>
              ...
              <div className="layout-overlay">
                <button className="preview-btn" onClick={() => navigate("/signup")}>
                  Use This Layout
                </button>
              </div>
