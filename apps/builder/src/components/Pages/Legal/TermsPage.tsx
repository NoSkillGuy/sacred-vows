      ...
      <div className="legal-page">
        <div className="legal-content">
          ...
          <section className="legal-section">
            ...
            <p>
              Sacred Vows provides a digital platform for creating, customizing, and sharing 
          ...
          <section className="legal-section">
            ...
            <h3>Your Content</h3>
            <p>
              You retain ownership of any content you create, upload, or share through the 
              Service ("User Content"). By using our Service, you grant us a non-exclusive, 
              royalty-free license to use, display, and distribute your User Content solely 
          ...
          <section className="legal-section">
            ...
            <h3>Pricing</h3>
            <p>
              Certain features of the Service require payment. Current prices are displayed 
              on our pricing page. We reserve the right to change prices at any time, but 
              changes will not affect existing purchases.
            </p>
            <h3>Billing</h3>
            <p>
              Premium plans are one-time purchases. By purchasing a plan, you agree to pay 
              the applicable fees. All payments are processed securely through our payment 
              providers.
            </p>
            <h3>Refunds</h3>
            <p>
              We offer a 30-day money-back guarantee for paid plans. If you are not satisfied 
          ...
          <section className="legal-section">
            ...
            <p>
              You agree to indemnify and hold harmless Sacred Vows and its affiliates from 
          ...
          <section className="legal-section">
            ...
            <div className="contact-info">
              <p><strong>Email:</strong> legal@sacredvows.com</p>
