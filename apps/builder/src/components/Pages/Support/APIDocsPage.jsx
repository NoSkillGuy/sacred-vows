...
const KeyIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M21 2L19 4M11.3891 11.6109C12.3844 12.6062 13 13.9812 13 15.5C13 18.5376 10.5376 21 7.5 21C4.46243 21 2 18.5376 2 15.5C2 12.4624 4.46243 10 7.5 10C9.01878 10 10.3938 10.6156 11.3891 11.6109ZM11.3891 11.6109L15 8M15 8L18 11L21 8L18 5L15 8Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
      ...
      <div className="api-docs-page">
        ...
        <section className="api-section">
          ...
          <div className="api-card">
            ...
            <p>Generate your API key from the <strong>Settings → API</strong> section in your dashboard.</p>
          </div>
        </section>
        ...
        <section className="api-section">
          ...
          <div className="api-card">
            ...
            <ul className="rate-limits">
              ...
              <li><strong>Premium Plan:</strong> 1,000 requests/hour</li>
              <li><strong>Luxury Plan:</strong> 10,000 requests/hour</li>
            </ul>
