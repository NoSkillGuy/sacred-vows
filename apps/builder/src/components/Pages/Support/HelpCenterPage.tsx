...
const PaletteIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C12.78 22 13.44 21.39 13.44 20.5C13.44 20.12 13.29 19.78 13.05 19.53C12.82 19.28 12.67 18.95 12.67 18.57C12.67 17.78 13.28 17.14 14.07 17.14H16C19.31 17.14 22 14.45 22 11.14C22 6.07 17.52 2 12 2Z"
      stroke="currentColor"
      strokeWidth="2"
    />
...
const helpCategories = [
  ...
  },
  {
    ...
    description: "Learn how to share your invitation with guests",
    articles: [
      "Sharing your invitation link",
      "Personalizing for guests",
      "Creating QR codes",
  ...
  },
  {
    ...
    description: "Track responses and manage your guest list",
    articles: [
      "Understanding RSVP tracking",
  ...
  },
  {
    ...
    icon: <CreditCardIcon />,
    title: "Billing & Plans",
    description: "Questions about pricing, upgrades, and payments",
    articles: [
...
const popularArticles = [
  ...
  { title: "Can I upload my own images?", category: "Design" },
];
...
function HelpCenterPage() {
  ...
  return (
    <PageLayout
      title="Help Center"
      subtitle="Find answers, get support, and learn how to create beautiful wedding invitations."
      breadcrumbs={[{ label: "Support", path: "/help" }, { label: "Help Center" }]}
    >
          ...
          <div className="categories-grid">
            {helpCategories.map((category) => (
              <Link key={category.id} to={category.link} className="category-card">
                ...
                <span className="category-link">View all articles →</span>
              </Link>
            ))}
          </div>
        </section>
        ...
        <section className="popular-articles">
          ...
          <div className="articles-list">
            {popularArticles.map((article, index) => (
              <Link key={index} to="/faqs" className="article-item">
