...
const CrownIcon = (): ReactElement => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M2 17L4 7L8 11L12 3L16 11L20 7L22 17H2Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "Absolutely! You can upgrade from any plan at any time. Your existing invitation designs will be preserved, and you'll gain access to all new features immediately.",
  },
  {
    question: "Is this a subscription or one-time payment?",
    answer:
      "Our Premium and Luxury plans are one-time payments. Once you purchase, you own it forever - no recurring charges or hidden fees.",
  },
  {
    question: "What happens after my wedding?",
    answer:
      "Your invitation stays live forever! Many couples keep it as a digital keepsake. You can also download all your RSVPs and guest data anytime.",
  },
  {
