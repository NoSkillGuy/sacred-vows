  ...
  return (
    <footer className="ee-section ee-footer-section">
      <div className="ee-footer-container" style={{ textAlign: 'center' }}>
        <h3 className="ee-section-heading" style={{ fontSize: '32px', marginBottom: 'var(--ee-space-sm)' }}>
          <EditableText
            value={brideName}
            onUpdate={onUpdate}
        ...
        <p style={{ color: 'var(--ee-color-secondary)', fontSize: '12px', marginTop: 'var(--ee-space-sm)' }}>
          © {year}
        </p>
      </div>
    </footer>
