 ...
 */
export function parseInvitationData(data: unknown, fallback: Record<string, unknown> = {}): Record<string, unknown> {
 ...
 */
export function ensureDataIsObject(data: unknown, fallback: Record<string, unknown> = {}): Record<string, unknown> {
 ...
 */
export function calculateSectionEnabled(manifestSection: { enabled?: boolean; defaultEnabled?: boolean }): boolean {
