 ...
 */
export function getDefaultAssetUrl(category: string, subcategory: string | null, filename: string): string {
 ...
 */
export async function preloadDefaultAssets(layoutId: string, assetPaths: string[] = []): Promise<void> {
