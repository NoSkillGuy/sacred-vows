 ...
 * @param {Object} invitation - Complete invitation object with layoutId, data, and layoutConfig
 * @param {Object} translations - Translation data
 * @returns {Promise<string>} Generated HTML
 */
export async function generateInvitationHTML(invitation, translations) {
 ...
 */
function generateFallbackHTML(invitation) {
 ...
 * @param {Object} invitation - Complete invitation object
 */
export function exportInvitationAsJSON(invitation) {
