...
import { getInvitations, getInvitation, createInvitation, updateInvitation, deleteInvitation, autoSaveInvitation } from './invitationService';
...
describe('invitationService', () => {
  ...
  describe('autoSaveInvitation', () => {
    it('should return a debounced save function', () => {
      const debouncedSave = autoSaveInvitation('inv-1', { couple: { bride: { name: 'Sarah' }, groom: { name: 'John' } } }, 100);
