...
interface BrandKitTheme extends ThemeConfig {
  ...
  layout: {
    ...
    grid: {
      ...
      gutters: { mobile: string; desktop: string };
    };
  };
  typography: {
...
function mergeDeep(
  base: Partial<BrandKitTheme> = {},
  override: Partial<BrandKitTheme> = {}
): BrandKitTheme {
...
export function mergeBrandThemes(...themes: Array<Partial<BrandKitTheme>>): BrandKitTheme {
  return themes.reduce((acc, theme) => mergeDeep(acc, normalizeThemeInput(theme)), {
