...
import type { ThemeConfig } from '@shared/types/layout';

interface BrandKitTheme extends ThemeConfig {
  preset: string;
  colors: {
    primary: string;
    secondary: string;
  ...
  states: {
    ...
    active: { primary: string; secondary: string; accent: string };
    focus: { ring: string };
    disabled: { background: string; text: string; border: string };
  };
  gradients: {
    hero: { start: string; end: string; angle: string };
    cta: { start: string; end: string; angle: string };
  };
  overlays: {
    imageVeil: string;
    card: string;
  ...
  radii: { xs: string; sm: string; md: string; lg: string; xl: string; pill: string };
  borders: {
    soft: { color: string; width: string; style: string };
    strong: { color: string; width: string; style: string };
    divider: { color: string; width: string; style: string };
    dashed: { color: string; width: string; style: string };
  };
  spacing: {
    scale: {
      xxs: string;
    ...
    gaps: { cards: string; grid: string };
  };
  layout: {
    container: { maxWidth: string; narrowWidth: string; padding: { mobile: string; desktop: string } };
    breakpoints: { xs: string; sm: string; md: string; lg: string; xl: string };
    grid: { columns: { mobile: number; desktop: number }; gutters: { mobile: string; desktop: string } };
  };
  typography: {
    family: { heading: string; body: string; script: string };
    ...
    lineHeights: { display: number; heading: number; body: number; tight: number };
    letterSpacing: { caps: string; body: string; tight: string };
    decorations: { underlineOffset: string; linkDecoration: string };
  };
  links: { color: string; hoverColor: string; visitedColor: string; decoration: string; hoverDecoration: string };
  buttons: {
    primary: {
      background: string;
      text: string;
  ...
  chips: {
    fill: { background: string; text: string };
  ...
  cards: {
    ...
    shadow: string;
    radius: string;
    padding: { dense: string; default: string; relaxed: string };
  };
  dividers: {
    color: string;
    thickness: string;
  ...
  icons: { stroke: string; corner: string; size: string; color: string };
  imagery: { tint: string; saturation: number; vignette: string; blur: string };
  illustrations: { style: string; primaryColor: string; secondaryColor: string; backgroundColor: string };
  motion: {
    duration: { fast: string; base: string; slow: string };
    easing: { standard: string; emphasized: string; out: string };
    distance: { x: string; y: string };
  };
  sections: {
    hero: { layout: string; padding: { mobile: string; desktop: string }; accent: string };
    story: { layout: string; padding: { mobile: string; desktop: string } };
    events: { layout: string; padding: { mobile: string; desktop: string } };
    gallery: { layout: string; padding: { mobile: string; desktop: string } };
    rsvp: { layout: string; padding: { mobile: string; desktop: string } };
  };
  cta: {
    layouts: { stacked: boolean; inline: boolean; iconPosition: string };
    spacing: { mobile: string; desktop: string };
  };
  shell: {
    header: { background: string; divider: string };
    footer: { background: string; divider: string };
    social: { iconFill: string; iconBackground: string };
  };
  accessibility: {
    focusRing: string;
    contrastTarget: { text: string; largeText: string };
    minTapSize: string;
  };
}

const DEFAULT_BRAND_KIT_THEME: BrandKitTheme = {
  preset: 'heritage-red',
  colors: {
    primary: '#b21f2d',
    secondary: '#8c0f1f',
...
function normalizeThemeInput(theme: Partial<BrandKitTheme> = {}): Partial<BrandKitTheme> {
...
function mergeDeep(base: Partial<BrandKitTheme> = {}, override: Partial<BrandKitTheme> = {}): BrandKitTheme {
  const result = { ...base } as BrandKitTheme;
  ...
  return result as BrandKitTheme;
}
...
function buildCSSVariables(theme: BrandKitTheme): CSSVariables {
...
export function mergeBrandThemes(...themes: Array<Partial<BrandKitTheme>>): BrandKitTheme {
...
export function resolveBrandTheme(theme?: Partial<BrandKitTheme>): BrandKitTheme {
  return mergeBrandThemes(theme || {});
}

export function themeVarsFromConfig(theme?: Partial<BrandKitTheme>): CSSVariables {
  return buildCSSVariables(resolveBrandTheme(theme));
}

export function applyThemeToDocument(
  theme?: Partial<BrandKitTheme>,
