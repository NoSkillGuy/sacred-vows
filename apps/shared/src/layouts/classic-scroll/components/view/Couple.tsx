import { getDefaultAssetUrl, convertAssetPathToUrl } from "@shared/utils/assetService";
    ...
    <section id="couple">
      <div className="section-header">
        <div className="section-eyebrow">
          {getTranslation("couple.eyebrow") || "Couple & Families"}
        </div>
          ...
          <div className="couple-grid">
            <div>
              ...
              <p className="muted">
                ...
                <strong>{brideMother}</strong> & <strong>{brideFather}</strong>.
              </p>
            ...
            <div>
              ...
              <p className="muted">
                ...
                <strong>{groomMother}</strong> & <strong>{groomFather}</strong>.
              </p>
